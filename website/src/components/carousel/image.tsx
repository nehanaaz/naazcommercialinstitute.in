...
export function ImageCarousel({ images }: { images: string[] }) {
    ...
    return (
        <div
            ref={containerRef}
            className="group relative rounded-3xl overflow-hidden border border-border/50"
...
function ProgressItem({ className, progress, ...props }: ComponentProps<'div'> & { progress?: number }) {
    return (
        <div
            className={cn(
